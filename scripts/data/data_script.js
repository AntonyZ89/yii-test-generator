$(document).on('click', '.adicionar_value', function () {
    ...
    let valueHTML = `
<li class="row col-5">
    <input class="form-control col-4" name="data[values][${value.children().length}][key]" placeholder="Chave">
    <div class="col-2 separador"><i class="fas fa-angle-double-right"></i></div>
    <input class="form-control col-4" name="data[values][${value.children().length}][value]" placeholder="Valor">
